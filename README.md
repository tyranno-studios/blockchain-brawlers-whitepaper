...
There were several items that were given away or used as keys to grant access to sales and promotional activities. The below listed items no longer serve their original purpose and merely maintain sentimental value 
 ...
 #### [Golden Battletags](https://wax.atomichub.io/market?collection_name=bcbrawlers&order=asc&search=golden%20battle%20tag&sort=price&symbol=WAX) - this was originally given away to 90 select players to be able to purchase a Ric Flair legendary 1 of 1 Series 1 NFT Brawler for use in the Mining Phase. Its future utility is non-existent, yet continues to be the punchline for many jokes told be insiders.
