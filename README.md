...
(1) Common Attack move. Go [here](https://wax.atomichub.io/market?collection_name=bcbrawlers&data:text.rarity=Common&order=asc&schema_name=moves&sort=price&symbol=WAX) to acquire a common attack. 
